  ...
  - [1.4. Property `DiffScope Project Exchange Format > content > tracks`](#content_tracks)
    - [1.4.1. DiffScope Project Exchange Format > content > tracks > Track](#content_tracks_items)
      ...
      - [1.4.1.5. Property `DiffScope Project Exchange Format > content > tracks > Track > workspace`](#content_tracks_items_workspace)
        - [1.4.1.5.1. Property `DiffScope Project Exchange Format > content > tracks > Track > workspace > Workspace Item`](#content_tracks_items_workspace_additionalProperties)
...
###### <a name="content_tracks_items_workspace_additionalProperties"></a>1.4.1.5.1. Property `DiffScope Project Exchange Format > content > tracks > Track > workspace > Workspace Item`
